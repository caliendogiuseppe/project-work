...
const renderAndPaginateReports = () => {
    ...
    // se arrivano dati (report dalla chiamata al backend), compila html
    if (formattedArray[0].items.length != 0) {
                ...
                for (report of item.items) {
                    ...
                    card.innerHTML = `
                        ...
                        <div class="report-card--actions">
                            ...
                            <a href="${CONFIG.HOST + CONFIG.STATIC_FOLDER_URL + report.filename}" target="_blank">
                            ...
                            <!-- link per scaricare-->
                            <a href="${CONFIG.HOST + CONFIG.DIRECT_DONWLOAD_URL + report.filename}" ">
                                <svg width="25px" height="25px" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        `<div class="no-reports-found">
            <h2> Nessun report trovato </h2>
            <svg width="60" height="60" viewBox="0 0 30 30" xmlns="http://www.w3.org/2000/svg" fill="none">
                <path d="M4 8C4 7.44772 4.44772 7 5 7H12L13.5 9H25C25.5523 9 26 9.44772 26 10V23C26 23.5523 25.5523 24 25 24H5C4.44772 24 4 23.5523 4 23V8Z" fill="#F2F2F2" stroke="#000" stroke-width="1.5"/>

                <line x1="12" y1="14" x2="18" y2="20" stroke="#000" stroke-width="1.5" stroke-linecap="round"/>
                <line x1="18" y1="14" x2="12" y2="20" stroke="#000" stroke-width="1.5" stroke-linecap="round"/>
            </svg>
        </div>`
    }
}
