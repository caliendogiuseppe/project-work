...
document.addEventListener("DOMContentLoaded", async () => {
    ...
    renderReports(data.data) //console.log(data.data[0])
        ...
        card.innerHTML = `
            ...
            <div class="report-card--values">
                <ul class="report-values-list">
                    <li><span class="label">Produzione totale:</span> <span class="value">${item.produzione_totale} t</span></li>
                    <li><span class="label">Fatturato netto:</span> <span class="value">${item.fatturato_netto} M€</span></li>
                    <li><span class="label">Dipendenti:</span> <span class="value">${item.dipendenti}</span></li>
                    <li><span class="label">Emissioni CO₂:</span> <span class="value">${item.emissioni_co2} t</span></li>
                    <li><span class="label">Consumo acqua:</span> <span class="value">${item.consumo_acqua_totale} m³</span></li>
                </ul>
            </div>
